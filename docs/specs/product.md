...
Canonical terms used below (Candidate, Pre-filter, Criteria, Outlier Guards, Live Snapshot, Deal Gate, Reference Price, Amazon Attestation, Price Validity, Discount Magnitude) are defined in [`../../GLOSSARY.md`](../../GLOSSARY.md).
